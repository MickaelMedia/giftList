        ...
        <div>
            ...
            <div className="input">
                ...
                <div className="gifts__area">
                    ...
                    {choice === "All" || choice === "MTB" || choice === "Camera"? <SubGifts id="test" title="Sports Watch"  description="I think a sports watch for mtb might be cool, but its kinda hard to decide which one is the best." price="299" image="https://static.garmincdn.com/en/products/010-02064-00/v/cf-lg-18a7a0af-8bbf-4bba-9468-e4969090e9ca.jpg" url={"https://www.garmin.com/fr-CA/p/621802"}/> : <div style={{display:"none"}}></div>}
