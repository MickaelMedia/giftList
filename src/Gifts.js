        ...
        <div>
            ...
            <div className="input">
                ...
                <div className="gifts__area">
                    ...
                    {choice === "All" || choice === "MTB"? <SubGifts title="HeadSet Adapter for Garmin" image="https://k-edge.com/wp-content/uploads/2016/04/UPC_3x3_K13-530-BLK.jpg" description="Allows me to put my computer on my bike safely" price="40 CAD" url="https://k-edge.com/shop/computer-mounts/garmin-mounts/adjustable-garmin-stem-mount/"/> : <div style={{display:"none"}}></div>}
                    ...
                    {choice === "All" || choice === "MTB" || choice === "Camera"? <SubGifts id="test" title="Sports Watch"  description="Honestly I found 2 watches that really look cool, The epix and the Fenix7 from GARMIN" price="800CAD" image="https://static.garmincdn.com/en/products/010-02064-00/v/cf-lg-18a7a0af-8bbf-4bba-9468-e4969090e9ca.jpg" url={"https://www.garmin.com/fr-CA/p/621802"}/> : <div style={{display:"none"}}></div>}
